...
{
    [TestFixture]
    public static class CountMultiplesTests
    {
        ...
        private static void tests(long[][] list1, long[] results)
        {
            for (int i = 0; i < list1.Length; i++)
                testing(CountMultiples.CountSpecMult(list1[i][0], list1[i][1]), results[i]);
            return;
        }
        [Test]
        public static void test1()
        {
            ...
            long[][] l = new long[][] { new long[] {2, 100},new long[] {2, 1000},new long[] {2, 10000},new long[] {2, 100000},new long[] {3, 100},
